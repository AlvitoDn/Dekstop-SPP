...
namespace Try_SPP_Alvito
{
    public partial class Login : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                SqlDataAdapter sda = new SqlDataAdapter("Select username, password, level from tb_petugas where username = '" + textBox1.Text + "' and Convert(VARCHAR,password)= '" + textBox2.Text + "'", conn);
